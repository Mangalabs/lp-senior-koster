    ...
    <nav class="container mx-auto px-6 py-4">
      <div class="flex items-center justify-between">
        <div class="font-display flex items-center">
          <img src="/icon (1).png" class="w-40 h-auto" alt="Logo">
        </div>
        ...
        <div class="hidden md:flex space-x-3">
          <a href="https://wa.me/5541932773923" target="_blank" class="btn-primary text-white px-4 py-2 rounded-full text-sm font-medium">
            WhatsApp
          </a>
          <a href="#" class="btn-secondary text-white px-4 py-2 rounded-full text-sm font-medium">
            iFood
          </a>
        </div>
      ...
      <div v-if="isOpen" class="md:hidden mt-4 flex flex-col space-y-4 bg-white p-4 rounded-lg shadow-lg">
        <a href="#home" class="text-gray-700 hover:text-pink-400 transition-colors">Home</a>
        <a href="#produtos" class="text-gray-700 hover:text-pink-400 transition-colors">Produtos</a>
        <a href="#sobre" class="text-gray-700 hover:text-pink-400 transition-colors">Sobre</a>
        <a href="#reservas" class="text-gray-700 hover:text-pink-400 transition-colors">Reservas</a>
        ...
        <div class="flex flex-col space-y-3 pt-2 border-t border-gray-200">
          <a href="https://wa.me/5541932773923" target="_blank" class="btn-primary text-white px-4 py-2 rounded-full text-sm font-medium text-center">
            WhatsApp
          </a>
          <a href="#" class="btn-secondary text-white px-4 py-2 rounded-full text-sm font-medium text-center">
            iFood
          </a>
        </div>
      </div>
