export const productsData = {
  ...
  description: "Produtos artesanais feitos com amor",
  products: [
    {
      id: 1,
      title: "Bolos Artesanais",
      description: "Bolos únicos com sabores especiais e decoração personalizada",
      img: "/bolo-artesanal.jpg",
    ...
    },
    {
      id: 2,
      title: "Pães Frescos",
      description: "Pães artesanais assados diariamente com fermentação prolongada",
      img: "/pão-com-queijo.jpeg",
    ...
    },
    {
      ...
      description: "Cheesecake, brigadeiros gourmet e doces para ocasiões especiais",
      img: "/cheesecake.jpg",
      gradient: "bg-gradient-to-br from-blue-100 to-blue-200",
      bgColor: "bg-white",
      textColor: "text-neutro-escuro"
